...
class GptOss_safeguardClient(AgentInterface):
    """
    Client implementation for GPT OSS Safeguard.
    ...
    Attributes:
        name (str): Hardcoded as "GPT OSS Safeguard".
        model (str): Specific model path: "openai/gpt-oss-safeguard-20b".
    """

    def __init__(self, api_key: str | None = None):
        """
        Initializes the GPT OSS Safeguard Client with the specific Groq model name.
    ...
    def generate_text(self, prompt: str) -> str:
        """
        Generates text using the GPT OSS Safeguard model.
